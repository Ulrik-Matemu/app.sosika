                        ...
                        <div className="flex  sm:flex-row items-start sm:items-end gap-6">
                            ...
                            <div className="flex-1">
                                ...
                                <div className="flex items-center  text-gray-600 mb-4">
                                    <span className="flex w-full justify-center bg-blue-100 text-blue-800 px-2 py-1 rounded-lg text-sm">
                                ...
                                {!isEditing && (
                                    <button
                                        ...
                                        className="flex justify-center bg-blue-600 w-full hover:bg-blue-700 text-white px-6 py-2 font-bold rounded-xl flex items-center gap-2 transition-colors shadow-lg"
                                    >
                                        Edit Profile
                                    </button>
                                )}
                    ...
                    <div className="bg-white dark:bg-[#080808] rounded-br-2xl px-4">
                        ...
                        <div className="space-y-4">
                            {isEditing ? (
                                ...
                                <>
                                    <div className="flex items-center p-4 bg-gray-100 dark:bg-[#121212] rounded-xl">
                                        <Store className="w-5 h-5 text-gray-600 mr-3 dark:text-gray-200" />
                                        <div>
                                            <p className="text-sm text-gray-500 dark:text-gray-400">Business Type</p>
                                            <p className="font-medium text-gray-900 dark:text-gray-200">{vendor.category}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center p-4 bg-gray-100 dark:bg-[#121212] rounded-xl">
